<template lang="html">
  <div class="mod-albums">
    <div class="hd log url">
        <h2>最近热门</h2>
   <router-link :to="{ name:'MoreList',params:{musictype:2,title:'今日热门'}}" tag="div">
          更多
        </router-link>
    </div>
    <div class="container">
...
export default {
  ...
  mounted() {
    ...
    var url =
      this.HOST +
      "/v1/restserver/ting?method=baidu.ting.billboard.billList&type=2&size=3&offset=0";
    this.$axios
      .get(url)
      .then(res => {
